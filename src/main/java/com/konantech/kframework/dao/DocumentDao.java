...
public class DocumentDao {
	...
	@Value("#{kframework['documentHilite']}") private String documentHilite;
	...
	public ResultListVO restSearch(ParameterVO param) throws Exception {
		...
		searchVO.setHiliteFileds(URLEncoder.encode(documentHilite, "UTF-8"));
		searchVO.setHiliteTxt(URLEncoder.encode(paramVO.getHiliteKwd(), "UTF-8"));
	...
	public ResultListVO submitQuery(ParameterVO param) throws Exception {
		...
		search.setHiliteTxt(paramVO.getHiliteKwd());
